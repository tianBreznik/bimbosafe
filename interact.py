...
def run():
    ...
    while True:
        ...
        raw_text = sock.ReadReceivedData() # read data
        while not raw_text:
            #print('Prompt should not be empty!')
            #raw_text = input(">>> ") 
            raw_text = sock.ReadReceivedData()
        print(raw_text)
        ...
        #for dataresp in chatbot.ask(data["text"]):
        #    response = dataresp["message"]
        for data in chatbot.ask(raw_text):
            response = data["message"]
        
        #data["modelresponse"] = response
        #sock.SendData(json.dumps( data ))
